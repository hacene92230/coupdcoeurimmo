 ...
 */
final class Version20230314135817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties ADD categories_id INT NOT NULL');
        $this->addSql('ALTER TABLE properties ADD CONSTRAINT FK_87C331C7A21214B7 FOREIGN KEY (categories_id) REFERENCES category (id)');
